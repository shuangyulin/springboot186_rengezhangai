<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info'&& !ro.zhenduanneirong" label="诊断内容" prop="zhenduanneirong">
          <file-upload
          tip="点击上传诊断内容"
          action="file/upload"
          :limit="1"
          :multiple="true"
          :fileUrls="ruleForm.zhenduanneirong?ruleForm.zhenduanneirong:''"
          @change="zhenduanneirongUploadChange"
          ></file-upload>
        </el-form-item>  
        <div v-else>
          <el-form-item v-if="ruleForm.zhenduanneirong" label="诊断内容" prop="zhenduanneirong">
            <el-button type="text" size="small" @click="download($base.url+ruleForm.zhenduanneirong)">下载</el-button>
          </el-form-item>
        </div>    
      </el-col>      
      <el-col :span="12">
