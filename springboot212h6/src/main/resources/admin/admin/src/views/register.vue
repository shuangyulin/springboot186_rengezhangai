  ...
  <div>
      ...
      <div class="login-form">
		...
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm">
			...
			<!-- <div v-if="tableName=='yisheng'" class="input-group">
			   <div class="label">医生职位</div>
			   <div class="input-container">
			     <input v-model="ruleForm.yishengzhiwei" class="input" type="text" placeholder="医生职位">
			   </div>
			 </div> -->
			<el-form-item label="医生职位" class="input" v-if="tableName=='yisheng'">
			  <el-input v-model="ruleForm.yishengzhiwei" autocomplete="off" placeholder="医生职位"  />
			</el-form-item>
 ...
 //  }
	...
	.container {
		...
		background-repeat: no-repeat;
    				background-image: url(http://codegen.caihongy.cn/20220121/7902658698ba4d039a58f15707647bbc.png);
